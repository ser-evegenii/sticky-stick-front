...
var _a = io.__getMockApi(), WS_URL = _a.WS_URL, getMessages = _a.getMessages, postMessage = _a.postMessage, resetMessages = _a.resetMessages;
function mountWebSockets(args, cb) {
...
exports.mountWebSockets = mountWebSockets;
function getElement(args) {
    return (React.createElement(__1.WebSockets, { url: WS_URL }, shared_1.createFixtureConnectRenderCb(args)));
}
